                ...
                <form action="" method="POST">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="faq_category" id="faq_category" class="form-select @error('faq_category') is-invalid @enderror" required>
                            ...
                            <option value="Winngoo" {{ old('faq_category') == 'Winngoo' ? 'selected' : '' }}>Winngoo</option>
                            <option value="Winngoo Page" {{ old('faq_category') == 'Winngoo Page' ? 'selected' : '' }}>Winngoo Page</option>
                            <option value="Winngoo Coin" {{ old('faq_category') == 'Winngoo Coin' ? 'selected' : '' }}>Winngoo Coin</option>
                        </select>
                        @error('faq_category')
                        <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
